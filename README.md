...
ここまでご覧いただきありがとうございます。自分自身初めてのアプリ制作で、コードの理解をするためにほとんど手作業でコードを書いたことでかなり時間を要してしまいましたが、簡単なものであれば形にできる力がついたと実感しています。まだまだ学びたいことは山ほどありますが、今後もより多くの実装を通して腕を磨いていきたいと思っています。ゲストログインから是非アプリを見ていただけると嬉しいです。
