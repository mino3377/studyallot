...
export default function MaterialCheckTable({
  ...
  return (
    <Card className="gap-3 p-2 sm:p-4 space-y-3 ">
      ...
      <div className="flex justify-center">
        <div className="overflow-x-auto w-full max-h-[60vh]">
          <table className="w-full border-separate border-spacing-y-0 md:border-spacing-y-1">
            <thead>
              <tr>
                <th className="text-left text-xs text-muted-foreground px-1 py-1 md:px-2 md:py-1 w-[160px] md:w-[240px] sticky top-0 left-0 bg-background z-20">
                  セクション
                </th>
