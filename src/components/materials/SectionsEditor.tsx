        ...
        {show && (
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <Label className="hidden md:flex md:flex-col">各セクションの設定（タイトルは任意）</Label>
              {onBulkDelete && (
            ...
            <div className="space-y-2">
              {Array.from({ length: unitCount }).map((_, i) => (
                <div
                  key={i}
                  className="grid gap-2 grid-cols-[20px_0.2fr_1fr] md:grid-cols-[40px_120px_1fr_auto]"
                >
                  ...
                  <div className="flex flex-col items-start gap-1 md:flex-row md:items-center md:gap-2">
                    <Label
                      htmlFor={`section-order-${i + 1}`}
                      className="block md:hidden text-xs text-muted-foreground"
                    >
                      番号
                    </Label>
                    <Label
                  ...
                  <div className="hidden md:flex items-center justify-end md:mt-0">
                    <Button
                      type="button"
                      variant={null}
